 ...
 */
export type RosterEntry = { "type": "Provider", id: ProviderId, model?: string | null, } | { "type": "Skill", id: SkillId, } | { "type": "Mcp", id: McpId, } | { "type": "Agent", id: AgentId, background: boolean, };
