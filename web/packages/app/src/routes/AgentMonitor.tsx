...
import type { BgAgentSummary, StepKind } from '@forge/ipc';
...
// F-381: `StepKind` is generated by ts-rs (`@forge/ipc`). Re-exported here
// so existing imports from `./AgentMonitor` keep working.
